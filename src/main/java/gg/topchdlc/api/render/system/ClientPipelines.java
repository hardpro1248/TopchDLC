...
public class ClientPipelines {
    public static gg.topchdlc.api.render.system.CustomVertexConsumerProvider customVertexConsumerProvider;
    ...
    public static GpuBuffer getOrCreateUniformBuffer() {
        if (sharedUniformBuffer == null) {
            ...
            sharedUniformBuffer = RenderSystem.getDevice().createBuffer(
                    () -> "topchdlc:shared_chams_shader_uniform",
    ...
    public static final RenderLayer HUD = RenderLayer.of("topchdlc_hud",

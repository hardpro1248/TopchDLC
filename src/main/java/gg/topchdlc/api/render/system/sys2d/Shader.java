            ...
            int fragment = this.create(GL30.GL_FRAGMENT_SHADER, """
                    ...
                    void main() {
                        ...
                        if (shaderId == 0) { // RECTANGLE
                            ...
                            vec2 multiplier = 14.0 / resolution;
                            vec3 average = texture(tex, texCoords).rgb;
                            for (float d = 0.0; d < 32; d += 4.0) {
                            ...
                            float zoomFactor = 0.22; // Р С™Р С•РЎРЊРЎвЂћРЎвЂћР С‘РЎвЂ Р С‘Р ВµР Р…РЎвЂљ Р В·РЎС“Р СР В° РЎвЂћР С•Р Р…Р В°
                            ...
                            for (float d = 0.0; d < 16.0; d += 2.0) {
                                float angle = d * 0.785398; // 2 * PI / 8

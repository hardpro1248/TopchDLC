package gg.topchdlc.api.render.msdf;
...
import gg.topchdlc.vse.utils.client.text.ServerPrefix;
import gg.topchdlc.vse.utils.client.text.TextUtility;
import gg.topchdlc.vse.utils.client.text.EmojiUtility;
...
import gg.topchdlc.api.render.util.ResourceProvider;
...
public final class MsdfFont implements MinecraftHolder {
    ...
    public void applyGlyphs(Matrix4f matrix, String text, float size, float thickness, float spacing, float x, float y, float z, Color color1, Color color2, Color color3, Color color4, TextureUse tex, float smooth) {
        ...
        for (int i = 0; i < text.length(); i++) {
            ...
            if (rw[0] != -1 && rw[1] != -1) {
                Identifier id = Identifier.of("topchdlc", "images/ui/rw_prefix.png");
    ...
    public static class Builder {
        ...
        public Builder data(String dataFileName) {
            this.dataIdentifer = Identifier.of("topchdlc", "fonts/" + dataFileName + ".json");
            return this;
        }

        public Builder atlas(String atlasFileName) {
            this.atlasIdentifier = Identifier.of("topchdlc", "fonts/" + atlasFileName + ".png");
            return this;
        }

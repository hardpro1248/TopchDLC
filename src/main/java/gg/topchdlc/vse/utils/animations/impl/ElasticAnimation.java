...
public class ElasticAnimation extends OldAnimation {
    ...
    protected double getEquation(double x) {
        ...
        return Math.pow(2, -10 * (reallyElastic ? Math.sqrt(x1) : x1)) * Math.sin((float) ((x1 - (elasticity / 4)) * ((2 * Math.PI) / elasticity))) + 1;
    }
}

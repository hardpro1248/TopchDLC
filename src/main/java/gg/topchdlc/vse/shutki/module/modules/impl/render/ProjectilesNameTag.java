...
import gg.topchdlc.vse.shutki.module.modules.impl.render.esp.impl.NametagRenderer;
...
public class ProjectilesNameTag extends Module {
    public static final ProjectilesNameTag INSTANCE = new ProjectilesNameTag();

    private ProjectilesNameTag() {
        super("ProjectilesNameTag", Category.RENDER, "Отображение имен предметов");
    }
    ...
    EventBus<Event> events = event -> {
        if (event instanceof EventGameTick) {
            ...
            for (Entity entity : mc.world.getEntities()) {
                if (entity instanceof ProjectileEntity && !entity.isRemoved()) {
                    toRender.add(entity);
                }
            }
        }

...
import gg.topchdlc.api.ui.widgets.impl.BlockListWidget;
import gg.topchdlc.api.ui.widgets.impl.ItemListWidget;
 ...
 */
public class BlockListRenderer extends SettingRenderer<BlockListSetting> {

    private final BlockListWidget widget;

    public BlockListRenderer(BlockListSetting setting) {
        super(setting);
        widget = new BlockListWidget(this);
    }

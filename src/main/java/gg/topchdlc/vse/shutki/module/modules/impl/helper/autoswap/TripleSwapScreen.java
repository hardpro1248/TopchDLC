...
public class TripleSwapScreen extends Screen {
    private final TripleSwapMenuWidget widget;

    public TripleSwapScreen(TripleSwapMenuWidget widget) {
        super(Text.empty());
        this.widget = widget;
    }

 ...
 */
public class ItemListRenderer extends SettingRenderer<ItemListSetting> {

    private final ItemListWidget widget;

    public ItemListRenderer(ItemListSetting setting) {
        super(setting);
        widget = new ItemListWidget(this);
    }
